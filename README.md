      ...
      Gambar
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
				...
				<img class="d-block w-100" src="POWER 1.png" alt="First slide" />
            </div>
                      </div>
          <a class="carousel-control-prev" href="POWER 2.png" role="button" data-slide="prev">
            <span class="carousel-control-custom-icon" aria-hidden="true">
              <i class="fas fa-chevron-left"></i>
            </span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="POWER 3.png" role="button" data-slide="next">
            <span class="carousel-control-custom-icon" aria-hidden="true">
        ...
        <table class="table table-bordered">
          <tbody>
			 <tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td>Perumahan Panorama Serpong Blok B2 No. 24, Kelurahan Bakti Jaya, Kecamatan Setu, Kabupaten Tangerang Selatan, Provinsi Banten.																																		
			</td>
            </tr>
			 <tr>
              <td>Basis Nilai</td>
			...
			<tr>
              ...
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B020'54.7%22S+106%C2%B042'16.4%22E/@-6.3485137,106.7019841,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.348519!4d106.704559?entry=ttu">
               -6.348519, 106.704559										
                  </a></td>
            </tr>
			<tr>
